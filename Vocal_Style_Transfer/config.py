# Epoch Связанный гиперпараметр
n_epochs = 500
checkpoint_every = 100 # Сколько эпох сохранить

# Preprocessing Связанный гиперпараметр
...
num_mcep = 24 # То же, что и n_features

# Model Связанный гиперпараметр
...
# It seems to be used only in began
gamma_A = 0.5
gamma_B = 0.5
lambda_k_A = 0.001
lambda_k_B = 0.001
